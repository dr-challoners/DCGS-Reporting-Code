					...
					<fo:table-body>
						...
						<fo:table-row>
							...
							<fo:table-cell font-size="8pt">
								...
								<fo:block text-align="start" padding="2pt" font-size="7pt">Main Triangle = Current Position, Smaller Triangle (not always present) = Previous Position, Background Bar = Statistically Predicted Attainment Range</fo:block>
							</fo:table-cell>
	...
	<xsl:template match="Course">
		...
		<fo:table-row keep-together.within-column="always">
			...
			<fo:table-cell padding="1pt" display-align="center">
				<fo:block text-align="start" font-size="11pt" font-family="sans-serif" line-height="12pt" color="#555555">
